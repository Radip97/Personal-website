  ...
  return (
    <div className={pageStyles.main}>
      ...
      <aside className={pageStyles.sidebar}>
        {/* Profile Card */}
        <div className={pageStyles.sidebarProfile}>
          <div className={pageStyles.profileRing}>
            <img src="/profile.jpg" alt="Radip Shrestha" className={pageStyles.profileImg} />
          </div>
          <h2 className={pageStyles.profileName}>Radip Shrestha</h2>
          <div className={pageStyles.profileTitle}>Software Engineer</div>
          <div className={pageStyles.statusIndicator}>
            <span className={pageStyles.statusDot}></span>
        ...
        <nav className={pageStyles.sidebarNav}>
          <ul className={pageStyles.sidebarNavList}>
            <li><a href="#about" className={pageStyles.sidebarNavLink}>[01] About me</a></li>
            <li><a href="#projects" className={pageStyles.sidebarNavLink}>[02] Portfolio</a></li>
            <li><a href="#support" className={pageStyles.sidebarNavLink}>[03] Tech Support</a></li>
            <li><a href="#education" className={pageStyles.sidebarNavLink}>[04] Education</a></li>
            <li><a href="#contact" className={pageStyles.sidebarNavLink}>[05] Contact</a></li>
          </ul>
        </nav>

        {/* Social Icon links */}
        <div className={pageStyles.socialLinks}>
          <a href={`https://github.com/Radip97`} target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=radip.crestha@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email">
      ...
      <div className={pageStyles.contentArea}>
        ...
        <header className={pageStyles.terminalHeader}>
          <div className={pageStyles.welcomeMsg}>Welcome to Radip Shrestha's Terminal Node v1.0.0</div>
          <div className={pageStyles.promptCommand}>
            <span className={pageStyles.promptUser}>radip@nku-console</span>:<span className={pageStyles.promptDir}>~</span>$ <span className={pageStyles.promptText}>init-portfolio --theme=matrix-green</span>
          </div>
        </header>

        {/* About Section */}
        <section id="about" className={uiStyles.section} style={{ paddingTop: 0 }}>
        ...
        <section id="contact" className={uiStyles.section}>
          <div className={pageStyles.contactWrapper}>
            ...
            <p style={{ marginTop: "2rem", color: "var(--text-muted)", fontSize: "0.85rem", fontFamily: "var(--font-geist-mono), monospace" }}>
              (859) 287-5362
            </p>
          </div>
        </section>
